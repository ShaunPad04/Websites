...
1. Read `design-references/design-md-format.md` for the 9-section format.
2. Select 1-2 reference DESIGN.md files from `design-references/references/by-aesthetic/` matching the aesthetic direction.
