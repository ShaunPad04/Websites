...
1. Read `design-references/design-md-format.md` for the required 9-section structure.
2. Browse `design-references/design-md-index.md` and select 1-2 reference DESIGN.md files that match the chosen aesthetic direction. Read them for structural inspiration.
